namespace Vssoft.Common
{
    ...
    public class MainFormHelper
    {
        ...
        //public static void SelectAccordionControlItem(AccordionControl nbControl, object startModule, string codeExample = "")
        //{
        ...
        //            {
        //                tag.CodeExampleName = codeExample;
        ...
        //public static void SetCommandLineArgs(string[] args, out string startModule, out bool fullWindow, out string codeExample)
        //{
        ...
        //    {
        //        if (str.IndexOf(DemoHelper.StartModuleParameter, StringComparison.Ordinal) == 0)
        //        {
        ...
        //            fullWindow = true;
        //        }
        //        if (str.IndexOf(DemoHelper.ModuleCodeExampleParameter, StringComparison.Ordinal) == 0)
        //        {
        //            codeExample = DemoHelper.GetModuleCodeExampleParameterValue(str);
        //        }
        //        if (str.Equals(DemoHelper.ForceDirectXPainter, StringComparison.OrdinalIgnoreCase))
        //        {
        //            WindowsFormsSettings.ForceDirectXPaint();
        //        }
        //        if (str.Equals(DemoHelper.ShowAllDemos, StringComparison.OrdinalIgnoreCase))
        //        {
        //            ShowAllDemos = true;
        //        }
        //    }
        ...
        {
            XtraMessageBox.Show("Export", "Resources.ExportCaption", MessageBoxButtons.OK, MessageBoxIcon.Hand);
        }
