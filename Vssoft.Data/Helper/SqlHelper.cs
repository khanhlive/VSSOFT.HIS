namespace Vssoft.Data.Helper
{
    ...
    public class SqlHelper
    {
        ...
        private Vssoft.Data.Helper.SqlHelperException _sqlHelperException;
        ...
        public SqlHelper(SqlConnection connection)
        {
            ...
            if (connection == null)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("connection");
            }
        ...
        public SqlHelper(string connectString)
        {
            ...
            {
                throw new Vssoft.Data.Helper.SqlHelperException("connectString");
            }
        ...
        public string Commit(SqlTransaction myTransaction)
        {
            ...
            {
                throw new Vssoft.Data.Helper.SqlHelperException("myTransaction");
            }
            this.Result = "";
            try
            {
            ...
            catch (SqlException exception2)
            {
                ...
                this.RaiseErrorEventHander(new Vssoft.Data.Helper.SqlHelperException(this.Result, exception2.Number));
            }
            catch (Exception exception3)
            {
                ...
                this.RaiseErrorEventHander(new Vssoft.Data.Helper.SqlHelperException(this.Result));
            }
            return this.Result;
        }
        ...
        public DataSet ExecuteDataSet(SqlConnection myConnection, System.Data.CommandType commandType, string commandText, string[] myParams, object[] myValues)
        {
            if (myConnection == null)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("myConnection");
            }
            if (myConnection.State != ConnectionState.Open)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("Connnection is close");
            }
            if (string.IsNullOrEmpty(commandText))
            {
                throw new Vssoft.Data.Helper.SqlHelperException("commandText");
            }
            bool flag = false;
            if ((myParams != null) & (myValues != null))
            {
                ...
                {
                    throw new Vssoft.Data.Helper.SqlHelperException("Parameter count does not match Parameter Value count.");
                }
            }
            this.Result = "";
            ...
            catch (SqlException exception)
            {
                ...
                this.RaiseErrorEventHander(new Vssoft.Data.Helper.SqlHelperException(this.Result, exception.Number));
            }
        ...
        public DataSet ExecuteDataSet(SqlTransaction myTransaction, System.Data.CommandType commandType, string commandText, string[] myParams, object[] myValues)
        {
            ...
            {
                throw new Vssoft.Data.Helper.SqlHelperException("The transaction was rollbacked or commited, please provide an open transaction.");
            }
            bool flag = false;
            if ((myParams != null) & (myValues != null))
            {
        ...
        public string ExecuteNonQuery(StringCollection commandTexts, bool isTransaction)
        {
            ...
            {
                throw new Vssoft.Data.Helper.SqlHelperException("Null object", 0);
            }
        ...
        public string ExecuteNonQuery(SqlConnection myConnection, System.Data.CommandType commandType, string commandText, string[] myParams, object[] myValues)
        {
            ...
            if (myConnection == null)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("Connection is null");
            }
            if (string.IsNullOrEmpty(commandText))
            {
                throw new Vssoft.Data.Helper.SqlHelperException("commandText");
        ...
        public string ExecuteNonQuery(SqlTransaction myTransaction, System.Data.CommandType commandType, string commandText, string[] myParams, object[] myValues)
        {
            if (myTransaction == null)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("Transaction is null");
            }
            if (commandText == null)
            {
                throw new Vssoft.Data.Helper.SqlHelperException("commandText");
        ...
        private static string GetItem(string getStr, string data)
        {
            ...
            if (string.IsNullOrEmpty(data))
            {
                ...
                throw new Vssoft.Data.Helper.SqlHelperException(message);
            }
        ...
        private static bool IsAuthe(string data)
        {
            if (string.IsNullOrEmpty(data))
            {
                ...
                throw new Vssoft.Data.Helper.SqlHelperException(str);
            }
        ...
        public string Open()
        {
            ...
            {
                throw new Vssoft.Data.Helper.SqlHelperException("connectionString");
            }
            if (this._connection == null)
            {
        ...
        public string Open(SqlConnection myConnection)
        {
            ...
            if (myConnection.State != ConnectionState.Open)
            {
                try
                {
                    if (string.IsNullOrEmpty(this._connectionString))
                    {
                        throw new Vssoft.Data.Helper.SqlHelperException("_connectionString");
                    }
        ...
        private void RaiseErrorEventHander(Vssoft.Data.Helper.SqlHelperException e)
        {
            if (this.Error != null)
            {
                this.Error(this, e);
        ...
        public Vssoft.Data.Helper.SqlHelperException SqlHelperException =>
